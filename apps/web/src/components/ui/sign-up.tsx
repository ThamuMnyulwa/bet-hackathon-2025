        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignUp}>
              ...
              <div className="animate-element animate-delay-500">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Create a secure password" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" />
              ...
              <div className="animate-element animate-delay-600 flex items-center gap-3 text-sm">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" name="terms" className="custom-checkbox" />
                  <span className="text-foreground/90">I agree to the <a href="#" className="text-violet-400 hover:underline">Terms of Service</a> and <a href="#" className="text-violet-400 hover:underline">Privacy Policy</a></span>
                </label>
              </div>
